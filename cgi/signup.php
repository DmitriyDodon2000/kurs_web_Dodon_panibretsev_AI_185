...
<body>
	<div class="signup">
		...
		<div class="social">
			...
			<div id="uLogin" data-ulogin="display=small;theme=classic;fields=first_name,last_name;providers=vkontakte,gmail,mailru,facebook;hidden=other;mobilebuttons=0;">
